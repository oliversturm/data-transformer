...
/***/ function(module, exports) {
	...
	var _marked = [map, transformArrayOfArrays].map(regeneratorRuntime.mark);
	...
	function transformArrayOfArrays(source) {
					...
					var defaultName;
					return regeneratorRuntime.wrap(function transformArrayOfArrays$(_context2) {
									while (1) {
	...
	function flattenOneToN(data) {
					...
					var _marked2 = [findNfields].map(regeneratorRuntime.mark);

					var detectNfields = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
					...
					var actualNfields = function () {
									if (nFields === [] && detectNfields && data.length > 0) {
													return typeof detectNfields === "function" ? detectNfields(data) : findNfields(data[0]);
									} else {
													return nFields;
									}
					}();
